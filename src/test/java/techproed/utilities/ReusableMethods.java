...
public class ReusableMethods {
    ...
    public static void setValueByJS(WebElement element, String text) {    // tagi <input> olanlarin icin gecerli  // wie sendKeys()
    ...
    public static void JSExecutorSelectVisibleText(WebElement element, String text) {
        ((JavascriptExecutor) Driver.getDriver()).executeScript("arguments[0].removeAttribute('style')", element);
